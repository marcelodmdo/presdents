          ...
          <div class="contatos">
            <div class="contatos-text">
              ...
              <p class="mdl-typography--headline mdl-typography--font-light">
                Quer nos conhecer melhor ou falar sobre seu sorriso com um de nossos especialistas?
              </p>
            ...
            <div class="contato-form-section mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-cell--4-col-phone">
              ...
              <form action="" class="send-contato">
                ...
                <div class=" mdl-typography--text-center">
                  ...
                  <button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect enviar-mensagem-btn">
                    <span class="btn-text">Enviar mensagem</span> <i class="material-icons">send</i>
                  </button>
                </div>
              </form>
            </div>
            <div class="contato-section-content mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-cell--4-col-phone">
              <!-- Simple Textfield -->
              <div class="mdl-grid">
                <div class="mdl-cell">
                  <p class="mdl-typography--headline mdl-typography--text-center mdl-typography--font-light">
                    <a href="https://api.whatsapp.com/send?phone=5531996163022&text=Ol%C3%A1!%20Gostaria%20de%20saber%20sobre%20os%20seus%20servi%C3%A7os."
                      target="_blank">
                      <img class="whatsapp-icon" src="{{ url('public/images/whatsapp-icon.png') }}" /> <span class="mdl-typography--headline mdl-typography--text-center mdl-typography--font-light">WhatsApp</span>
                    </a>
                  </p>
                </div>
                <div class="mdl-cell">
                  <p class="mdl-typography--headline mdl-typography--text-center mdl-typography--font-light">
                    <a href="https://www.instagram.com/presdentsclinica/"
                      target="_blank">
                      <img class="whatsapp-icon" src="{{ url('public/images/instagram-icon-300.png') }}" /> <span class="mdl-typography--headline mdl-typography--text-center mdl-typography--font-light">Instagram</span>
                    </a>
                  </p>
                </div>
              </div>
              ...
              <p class="mdl-typography--headline mdl-typography--text-center mdl-typography--font-light">
                ...
                A Presdents é a Clínica da Família que foi criada pensando em você e na qualidade de vida da sua família. <br>
⠀                Venha nos visitar.
              </p>
              
              <!-- <div class="contato-section-title mdl-typography--display-2 mdl-typography--font-light">Agende sua avaliação</div> -->
              
              <!-- <p class="mdl-typography--headline mdl-typography--text-center mdl-typography--font-light">Via WhatsApp</p> -->
