...
@section('title', $tratamento["titulo"])
...
<section class="tratamento-reading-section">
    <div class="mdl-grid">
        <div class="mdl-cell mdl-cell--8-col mdl-cell--8-col-tablet mdl-cell--4-col-phone">
            <article class="reading-section">

                <div class="bg-trat-image"
                    style="background-image: url({{ url('public/images/tratamentos/') }}/{{$tratamento['image']}})">
                </div>
                <div class="mdl-typography--display-2 mdl-typography--font-thin">{{$tratamento["titulo"]}}</div>

                <div class="content">
                    @foreach($tratamento["content"] as $p)
                    {!!$p!!}
                    @endforeach
                </div>
            </article>
        ...
        <div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet mdl-cell--4-col-phone">
            <ul class="demo-list-icon mdl-list">
              @foreach($sideList as $i)
                <li class="mdl-list__item">
                  <a href="{{ url('tratamento') }}/{{$tipo}}/{{$i['slug'] }}">
            ...
            <form action="#" class="send-contato">
                <div class="form-response-box">
                    <div class="form-response ">
                        ...
                        <a
                            class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect dismiss-mensagem-btn">
                            <span class="btn-text">Okay</span> <i class="material-icons">check</i>
                        </a>
                    </div>
                </div>
                <div class="contato-section-title mdl-typography--display-2 mdl-typography--font-light">Fale conosco
                </div>
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <textarea class="mdl-textfield__input" type="text" rows="4" required name="mensagem"
                ...
                <div class=" mdl-typography--text-center">
                    ...
                    <button
                        class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect enviar-mensagem-btn">
